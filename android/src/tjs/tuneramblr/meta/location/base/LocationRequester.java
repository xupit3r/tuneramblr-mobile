package tjs.tuneramblr.meta.location.base;
...
/**
 * Abstract base class that can be extended to provide active and passive
 * location updates optimized for each platform release.
 * 
...
public abstract class LocationRequester {
	...
	protected LocationRequester(LocationManager locationManager) {
	 ...
	 * 
	 * @param minTime
	 *            Minimum time that should elapse between location update
	 *            broadcasts.
	 * @param minDistance
	 *            Minimum distance that should have been moved between location
	 *            update broadcasts.
	 * @param criteria
	 *            Criteria that define the Location Provider to use to detect
	 *            the Location.
	 * @param pendingIntent
	 *            The Pending Intent to broadcast to notify the app of active
	 *            location changes.
	 */
	 ...
	 *            update broadcasts.
	 * @param pendingIntent
	 *            The Pending Intent to broadcast to notify the app of passive
	 *            location changes.
	 */
