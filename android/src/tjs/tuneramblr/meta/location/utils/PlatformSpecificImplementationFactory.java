...
public class PlatformSpecificImplementationFactory {
	...
	public static ILastLocationFinder getLastLocationFinder(Context context) {
		return TuneramblrConstants.SUPPORTS_GINGERBREAD ? new GingerbreadLastLocationFinder(
	...
	public static IStrictMode getStrictMode() {
		if (TuneramblrConstants.SUPPORTS_HONEYCOMB)
			return new HoneycombStrictMode();
		else if (TuneramblrConstants.SUPPORTS_GINGERBREAD)
	...
	public static LocationRequester getLocationRequester(
		...
		return TuneramblrConstants.SUPPORTS_GINGERBREAD ? new GingerbreadLocationUpdateRequester(
				locationManager) : new FroyoLocationUpdateRequester(
				locationManager);
	}
	...
	public static SharedPreferenceSaver getSharedPreferenceSaver(Context context) {
		return TuneramblrConstants.SUPPORTS_GINGERBREAD ? new GingerbreadSharedPreferenceSaver(
				context)
				: TuneramblrConstants.SUPPORTS_FROYO ? new FroyoSharedPreferenceSaver(
